...
class MACHINE():
    ...
    def find_best_selection(self):
        ...
        if(len(self.drawn_lines) < len(available) * 0.5) : # 게임 초반
            heuristic_result = self.heuristic_algorithm(available)
            print("휴리스틱 사용! 휴리스틱 결과값 : ",heuristic_result)
    ...
    def heuristic_algorithm(self, available):
        ...
        for line in available:
            ...
            # 독립된 선분 가중치 추가
            independent_line_weight = 1  # 독립된 선분 가중치
